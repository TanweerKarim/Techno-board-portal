    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-12 col-xs-12">
          <h1 align="center">Syllabus For 3rd Semester</h1>
          <table align="center" style="margin-top:60px;font-size:28px;width:800px;margin-left:140px;">
            <tr>
              <td>Automobile Engineering</td>
              <td><a href="http://sbtejharkhand.nic.in/3rdSem/Automobile%20Engineering.zip">Download</a></td>
            </tr>
            <tr>
              <td>Civil Engineering</td>
              <td><a href="http://sbtejharkhand.nic.in/3rdSem/Civil%20Engineering.zip">Download</a></td>
            </tr>
            <tr>
              <td>Computer Science and Engineering</td>
              <td><a href="http://sbtejharkhand.nic.in/3rdSem/CSE.zip">Download</a></td>
            </tr>
            <tr>
              <td>Electrical Engineering</td>
              <td><a href="http://sbtejharkhand.nic.in/3rdSem/Electrical%20Engineering.zip">Download</a></td>
            </tr>
            <tr>
              <td>Electronics and Communication Engineering</td>
              <td><a href="http://sbtejharkhand.nic.in/3rdSem/ECE.zip">Download</a></td>
            </tr>
            <tr>
              <td>Mechanical Engineering</td>
              <td><a href="http://sbtejharkhand.nic.in/3rdSem/Mechanical.zip">Download</a></td>
            </tr>
          </table>
        </div>
      </div>
